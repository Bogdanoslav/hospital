...
public class SpecialistDoctorsSpecificationsTest {
  ...
  @Autowired private SpecialistDoctorRepository specialistDoctorRepository;

  @Autowired private SpecialistDoctorService specialistDoctorService;
  ...
  public void CreateDoctors() throws SQLException {
    ...
    specialistDoctorRepository.save(specialistDoctor1);
    specialistDoctorRepository.save(specialistDoctor2);
  }
